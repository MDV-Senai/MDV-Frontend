    ...
    <div id="fundoCards">
      <v-form ref="form" id="form" class="mx-auto">
        ...
        <v-row class="d-flex justify-center">
          <v-col cols="12" md="12">
            <v-text-field label="Descrição Da Vaga" :rules="[rules.required]" maxlength="255" counter clearable
              class="text-pink-darken-3" color="pink-darken-4"></v-text-field>
          </v-col>
        </v-row>
        <v-row class="d-flex justify-center">
          ...
          <v-col cols="12" md="6">
            <v-text-field label="Turma" :rules="[rules.required]" maxlength="255" counter clearable
              class="text-pink-darken-3" color="pink-darken-4"></v-text-field>
          </v-col>
        </v-row>
        ...
        <v-row id="inputResponsivo" class="d-flex justify-center">
          ...
          <v-col cols="12" md="6">
            <v-text-field label="Situação" :rules="[rules.required]" maxlength="255" counter clearable
              class="text-pink-darken-3" color="pink-darken-4"></v-text-field>
          </v-col>
